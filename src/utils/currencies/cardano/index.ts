...
// Types
import { TCardanoUnspentTxOutput } from './types'
...
const calculateFee = (
  outputs: TCardanoUnspentTxOutput[],
  ...
  try {
    ...
    if (transactionParams) {
      ...
      const sortOutputs = outputs.sort(
        (a: TCardanoUnspentTxOutput, b: TCardanoUnspentTxOutput) =>
          Number(a.ctaAmount.getCoin) - Number(b.ctaAmount.getCoin)
      )

      const selectedOutputs: TCardanoUnspentTxOutput[] = []
